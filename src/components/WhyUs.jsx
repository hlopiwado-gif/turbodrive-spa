...
import { FiCheckCircle, FiDroplet, FiFeather, FiFile, FiTool, FiSun } from 'react-icons/fi';
import './WhyUs.css';

const reasons = [
  {
    icon: <img src="/our-service-image/1.png" alt="All Certified Products" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />,
