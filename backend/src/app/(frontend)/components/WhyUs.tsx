...
// Fallback data when CMS has no reasons
...
export default function WhyUs({ data }: WhyUsProps) {
  const reasons = data.reasons.length > 0 ? data.reasons : fallbackReasons
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <div className="why-us__card-icon">
                <img src={reason.imageUrl} alt={reason.title} style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
              </div>
